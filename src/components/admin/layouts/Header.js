                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <div className="dropdown-divider"></div>
                            <a href="#" className="dropdown-item" data-toggle="modal" data-target="#myModal">

                                <div className="media">
                                    <img src="../../dist/img/lock.png" alt="User Avatar" className="img-size-50 img-circle mr-3" />
                                    <div className="media-body">
                                        <h3 className="dropdown-item-title">
                                            Change Password
                                        ...
                                        <p className="text-sm text-muted"><i className="fa fa-clock-o mr-1"></i>Last Updated 4 Hours Ago</p>
                                    </div>
                                </div>
                            ...
                            <div className="dropdown-divider"></div>
                            <a href="/home" className="dropdown-item dropdown-footer">Logout</a>
                        </div>
